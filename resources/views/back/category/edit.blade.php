    ...
    <div class="content-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.category.index') }}">Service</a></li>
        ...
        <div class="col-md-10 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('admin.category.update',$service->id) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control"
                                           value="{{ (!empty(old('name'))) ? old('name') : $service->name }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="name_ja" type="text" class="form-control"
                                           value="{{ (!empty(old('name_ja'))) ? old('name_ja') : $service->name_ja }}"
                                           placeholder="Service Name">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="text" id="summernote" cols="30" rows="5" class="form-control"
                                              placeholder="Enter text here">{{ (!empty(old('text'))) ? old('text') : $service->text }}</textarea>
                                    @if ($errors->has('text'))
                                        <span class="help-block">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="text_ja" id="summernote1" cols="30" rows="5"
                                              class="form-control"
                                              placeholder="Enter text here">{{ (!empty(old('text_ja'))) ? old('text_ja') : $service->text_ja }}</textarea>
